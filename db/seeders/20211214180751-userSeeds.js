...
module.exports = {
  ...
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert(
      "Users",
      [
        { username: 'ImFromSixthSense', passwordHash: 'password', firstName: 'Dr. Malcolm', lastName: 'Crowe', about: 'I know a kid. He sees dead people. That probably should have been my first clue.', profileImage: 'https://static.wikia.nocookie.net/unbreakablemovie/images/5/59/F68055971111e177f5116fd2f348d3e2.jpg/revision/latest?cb=20170831193250', email: "sixthsense@six.com", createdAt: new Date(), updatedAt: new Date() },
