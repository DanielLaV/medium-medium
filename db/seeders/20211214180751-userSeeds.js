...
module.exports = {
  ...
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert(
      "Users",
      [
        { username: 'Demo', passwordHash: 'password', firstName: 'Demo', lastName: 'User', about: "I'm a demo user", profileImage: 'https://scontent.ffcm1-1.fna.fbcdn.net/v/t1.18169-9/11193252_842973582440627_4172988355375099138_n.png?_nc_cat=103&ccb=1-5&_nc_sid=973b4a&_nc_ohc=OoUWOAvvArIAX9_gRqK&_nc_ht=scontent.ffcm1-1.fna&oh=00_AT-n7Z2bAYXb52_djZQNvagK7U2nXcTlsv9tBxLp-poAQA&oe=61E2F9B0', email: "demo@demo.com", createdAt: new Date(), updatedAt: new Date() },
